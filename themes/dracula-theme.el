...
(let ((colors '(;; Upstream theme color
      ...
      (faces '(;; default
               ...
               (org-document-title :weight bold :foreground ,dracula-orange :height 1.8)
               ...
               (org-level-1 :inherit bold :foreground ,dracula-pink :height 1.6)
               (org-level-2 :inherit bold :foreground ,dracula-purple :height 1.4)
               (org-level-3 :weight normal :foreground ,dracula-green :height 1.2)
